...
parser.add_argument('--log', type=str, metavar="LOGLEVEL", default='INFO',
...
parser.add_argument('--dispatch', type=str, default='stdout',
                    help="where to send the report to, options are: stdout, http (set KUBEHUNTER_HTTP_DISPATCH_URL and KUBEHUNTER_HTTP_DISPATCH_METHOD environment variables to configure)")
...
def delete_result():
    detect()
    return "You can get the results from this function's log"
